        ...
        <div className="mt-4 space-y-4">
          {filteredMatches.length === 0 ? (
            ...
            filteredMatches.map((match) => {
              ...
              // Marcadores KO: solo se revelan cuando el partido cierra (10 min antes),
              // igual que grupos. Antes de eso nadie puede copiar el pronóstico de otro.
              const revealed = !isKo || (!!match.scheduled_at && Date.now() >= new Date(match.scheduled_at).getTime() - 10 * 60 * 1000);
              return (
    ...
    <div className="rounded-lg border border-slate-200 bg-white">
      ...
      {isKnockout && !revealed ? (
        <div className="px-4 py-3 text-sm text-slate-500">
          🔒 Los marcadores predichos se revelan cuando el partido <strong>cierra</strong> (10 min antes del inicio), para que nadie copie.
        </div>
      ) : !hasAnyPick ? (
